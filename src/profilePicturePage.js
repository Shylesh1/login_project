        ...
        return(
            <div className="App">
                ...
                <div className="detailsBorderProfile">
                    {/* <div className="insideYellowBorder"><span className="usernameAlign">Welcome  {this.props.location.state?.username} <br></br><button className="profileLogoutButton" onClick={this.sessionHandler}>Logout</button></span></div> */}
